 ...
 */
export function selectModel(models: Map<string, ModelInfo>, modelPartial: string | undefined, providerPartial: string | undefined, ui: Ui, fs: FileSystem): Promise<ModelInfo>;
